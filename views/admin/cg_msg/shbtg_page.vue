...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">采购信息-审核不通过</h2>
			<div class="edit-form-div" id="checkRemarkForm">
				<div  class="edit-form-name">审核备注</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
						<el-input type="text"  placeholder="请输入审核备注" name="checkRemark" v-model="checkRemark" class="" id="checkRemark"></el-input>
					</div>
				</div>
			</div>
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/cg_msg/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/admin/cg_msg/shbtg_submit",
				async: false,
				data : {
					'id':that.id,
