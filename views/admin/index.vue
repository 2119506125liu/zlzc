				...
				<el-scrollbar>
					...
					<hr>
						<el-menu  @select="gotoIframePage">
							...
							<el-menu-item :index="'/admin/gzw/list'">
								国资委管理
							</el-menu-item>
							<el-menu-item :index="'/admin/jw_book/list'">
								纪委书记
							</el-menu-item>
							<el-menu-item :index="'/admin/staff/list'">
								员工管理
							</el-menu-item>
							<el-menu-item :index="'/admin/pbzj/list'">
								评标专家
							</el-menu-item>
							<el-menu-item :index="'/admin/cg_msg/list'">
								采购管理
							</el-menu-item>
							<el-menu-item :index="'/admin/yc_warning/list'">
								异常预警
							</el-menu-item>
							<el-menu-item :index="'/admin/gys_msg/list'">
								供应商管理
							</el-menu-item>
							<el-menu-item :index="'/admin/pro_msg/list'">
								商品管理
							</el-menu-item>
							<el-menu-item :index="'/admin/notice/list'">
								公告管理
							</el-menu-item>
							<el-menu-item :index="'/admin/company_staff/list'">
								企业员工管理
							</el-menu-item>
						</el-menu>
					</el-scrollbar>
