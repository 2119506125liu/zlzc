	...
	<el-card class="box-card"  style="margin-left:2%;width:95%;margin-top:20px;">
		...
		<div>
			...
			<div style="margin-top:5px;padding-left: 15px;">
				<el-button
					href="javascript:void(0)" :data-params="''" data-href="/admin/pbzj/add_page" @click="goToPage"
			...
			<div >
				<el-table
					...
					<el-table-column
						...
						<template v-slot="{ row }">
							<el-button
								href="javascript:void(0)" :data-id="row.pbzj.id" @click="del"
								type="danger" style="margin-left:5px;margin-top:5px;"
								>
								删除
							</el-button>
							<el-button
								href="javascript:void(0)" :data-params="'id='+row.pbzj.id+''" data-href="/admin/pbzj/update_page" @click="goToPage"
	...
	methods:{
		del(e){
			...
			if(r==true){
				$.ajax({
					type : 'get',
					url : this.REQUEST_URL+"/admin/pbzj/del",
					async: false,
					data : {
		...
		ajaxCount(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/admin/pbzj/queryCount',
				async: false,
				data : {
					"loginToken":that.currentLoginToken,
					"zjName":zjName,
		...
		ajaxList(page){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/admin/pbzj/queryList',
				async: false,
				data : {
					"page":page,
					"loginToken":that.currentLoginToken,
