...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			...
			<div class="edit-form-div" id="ghForm">
				<div  class="edit-form-name">工号</div>
...
export default {
	...
	methods:{
		...
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/staff/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
					'loginToken':that.currentLoginToken,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/admin/staff/update_submit",
				async: false,
				data : {
					'id':that.id,
					'gh':gh,
