...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">纪委书记-修改</h2>
			<div class="edit-form-div" id="loginNameForm">
				<div  class="edit-form-name">登录名</div>
			...
			<div class="edit-form-div" id="passwordForm">
				<div  class="edit-form-name">密码</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/jw_book/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/admin/jw_book/update_submit",
				async: false,
				data : {
					'id':that.id,
					'loginName':loginName,
