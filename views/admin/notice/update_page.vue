...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">公告-修改</h2>
			...
			<div class="edit-form-div" id="noticeContentForm">
				<div  class="edit-form-name">公告内容</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/admin/notice/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/admin/notice/update_submit",
				async: false,
				data : {
					'id':that.id,
					'title':title,
