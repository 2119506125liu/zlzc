...
<template>
	<div class="edit-page-div">
		<div class="box-card">
			<h2 class="edit-page-div-h2">企业员工-修改</h2>
			<div class="edit-form-div" id="staffNameForm">
				<div  class="edit-form-name">员工名</div>
			...
			<div class="edit-form-div" id="companyNameForm">
				<div  class="edit-form-name">企业名</div>
				<div class="edit-form-div2">
					<div class="edit-form-div3">
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/staff/company_staff/queryDataDetail",
				async: false,
				data : {
					'id':that.id,
				...
				success : function(result) {
					that.staffName=result.staffName;
					that.companyName=result.companyName;
		...
		submitData(){
			...
			$.ajax({
				type : 'post',
				url : this.REQUEST_URL+"/staff/company_staff/update1_submit",
				async: false,
				data : {
					'id':that.id,
					'staffName':staffName,
