...
<template>
	<div class="detail-page">
		<div class="detail-page-div">
			<h2 class="detail-page-name">公告</h2>
								...
								<div  class="detail-page-div6">
									<div class="admin-table">
										<div id="detailBody">
											...
											<div class="admin-table-div">
												<div class="col1">公告内容</div>
												<div class="col2" v-html="noticeContent==null?'':noticeContent"></div>
											</div>
											<div class="admin-table-div">
...
export default {
	...
	methods:{
		queryDataDetail(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+"/staff/notice/getDetailData",
				async: false,
				data : {
					'id':that.id,
				...
				success : function(result) {
					that.title = (result.detail.notice.title==null?'':result.detail.notice.title);
					that.fmImgList = result.detail.fmImgList;
					that.noticeContent = (result.detail.notice.noticeContent==null?'':result.detail.notice.noticeContent);
					that.fbTime = (result.detail.notice.fbTime==null?'':result.detail.notice.fbTime);
				}
			});
		},
	}
