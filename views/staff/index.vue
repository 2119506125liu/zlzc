...
<template>
	<div>
		<el-container class="layout-container-demo">
			<el-aside>
				<el-scrollbar>
					<h4><a  href="javascript:void(0)" >国企“智廉招采”风险监管系统</a></h4>
					<hr>
						<el-menu  @select="gotoIframePage">
							<el-menu-item :index="'/staff/personal'">
								个人信息
							</el-menu-item>
							<el-menu-item :index="'/staff/pbzj/list'">
								评标专家
							</el-menu-item>
							<el-menu-item :index="'/staff/cg_msg/list'">
								采购管理
							</el-menu-item>
							<el-menu-item :index="'/staff/zb_msg/list'">
								中标信息
							</el-menu-item>
							<el-menu-item :index="'/staff/gys_msg/list'">
								供应商管理
							</el-menu-item>
							<el-menu-item :index="'/staff/pro_msg/list'">
								商品管理
							</el-menu-item>
							<el-menu-item :index="'/staff/notice/list'">
								公告查询
							</el-menu-item>
							<el-menu-item :index="'/staff/company_staff/list'">
								企业员工管理
							</el-menu-item>
						</el-menu>
					</el-scrollbar>
				...
				<el-container>
					...
					<el-main>
						<el-scrollbar>
							<iframe  id="iframeDom"   src="/staff/personal"></iframe>
						</el-scrollbar>
					</el-main>
				</el-container>
			</el-container>
	...
	methods:{
		...
		getInitData(){
			...
			$.ajax({
				dataType:"json",
				type:"post",
				url:this.REQUEST_URL+"/staff/index/getInitData",
				data:{
