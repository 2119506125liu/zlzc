	...
	<el-card class="box-card"  style="margin-left:2%;width:95%;margin-top:20px;">
		...
		<div>
			...
			<div style="margin-top:5px;padding-left: 15px;">
				<el-button
					href="javascript:void(0)" :data-params="''" data-href="/staff/pro_msg/add1_page" @click="goToPage"
				...
				<el-table
					...
					<el-table-column label="商品图"  width="200px">
						...
						<el-table-column
							...
							<template v-slot="{ row }">
								<el-button
									href="javascript:void(0)" :data-id="row.proMsg.id" @click="del1"
									type="danger" style="margin-left:5px;margin-top:5px;"
									>
									删除
								</el-button>
								<el-button
									href="javascript:void(0)" :data-params="'id='+row.proMsg.id+''" data-href="/staff/pro_msg/update1_page" @click="goToPage"
	...
	methods:{
		...
		del1(e){
			...
			if(r==true){
				$.ajax({
					type : 'get',
					url : this.REQUEST_URL+"/staff/pro_msg/del1",
					async: false,
					data : {
						"loginToken":that.currentLoginToken,
						"id":dataId
		...
		ajaxCount(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/staff/pro_msg/queryCount',
				async: false,
				data : {
					"loginToken":that.currentLoginToken,
					"proName":proName,
		...
		ajaxList(page){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/staff/pro_msg/queryList',
				async: false,
				data : {
					"page":page,
					"loginToken":that.currentLoginToken,
