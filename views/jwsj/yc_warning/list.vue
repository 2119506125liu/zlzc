	...
	<el-card class="box-card"  style="margin-left:2%;width:95%;margin-top:20px;">
		...
		<div>
			...
			<div style="margin-top:5px;padding-left: 15px;">
				<el-button
					href="javascript:void(0)" :data-params="''" data-href="/jwsj/yc_warning/add_page" @click="goToPage"
				...
				<el-table
					...
					<el-table-column label="异常附图"  width="200px">
						...
						<el-table-column
							...
							<template v-slot="{ row }">
								<el-button
									href="javascript:void(0)" :data-id="row.ycWarning.id" @click="del1"
									type="danger" style="margin-left:5px;margin-top:5px;"
									>
									删除
								</el-button>
								<el-button
									href="javascript:void(0)" :data-params="'id='+row.ycWarning.id+''" data-href="/jwsj/yc_warning/update1_page" @click="goToPage"
	...
	methods:{
		...
		del1(e){
			...
			if(r==true){
				$.ajax({
					type : 'get',
					url : this.REQUEST_URL+"/jwsj/yc_warning/del1",
					async: false,
					data : {
						"loginToken":that.currentLoginToken,
						"id":dataId
		...
		ajaxCount(){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/jwsj/yc_warning/queryCount',
				async: false,
				data : {
					"loginToken":that.currentLoginToken,
					"ycType":ycType,
		...
		ajaxList(page){
			...
			$.ajax({
				type : 'get',
				url : this.REQUEST_URL+'/jwsj/yc_warning/queryList',
				async: false,
				data : {
					"page":page,
					"loginToken":that.currentLoginToken,
