		...
		<el-container class="layout-container-demo">
			<el-aside>
				<el-scrollbar>
					...
					<hr>
						<el-menu  @select="gotoIframePage">
							<el-menu-item :index="'/gzw/personal'">
								个人信息
							</el-menu-item>
							<el-menu-item :index="'/gzw/yc_warning/list'">
								异常预警
							</el-menu-item>
						</el-menu>
					</el-scrollbar>
				...
				<el-container>
					...
					<el-main>
						<el-scrollbar>
							<iframe  id="iframeDom"   src="/gzw/personal"></iframe>
						</el-scrollbar>
					</el-main>
				</el-container>
			</el-container>
	...
	methods:{
		...
		getInitData(){
			...
			$.ajax({
				dataType:"json",
				type:"post",
				url:this.REQUEST_URL+"/gzw/index/getInitData",
				data:{
